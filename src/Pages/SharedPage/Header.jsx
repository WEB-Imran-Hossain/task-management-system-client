...
const Header = () => {
  ...
  return (
    <>
      <div className="navbar fixed z-10 text-xl font-bold flex flex-row items-center justify-around text-[#FF7452] p-5 bg-[#1D2833]">
        ...
        <div className="navbar-start">
          ...
          <div>
            <Link to="/">
              <img className=" max-w-44 md:max-w-72 md:ml-20" src={logo} alt="" />
            </Link>
          </div>
        </div>
